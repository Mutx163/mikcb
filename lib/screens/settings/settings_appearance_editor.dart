...
/// * 版式：沉浸式暗底 + 圆角卡片 + 顶部胶囊按钮 + 底部一排圆钮 + 弹窗打开时上下
///   chrome 淡出（用户指定按这个版式做，别改成普通设置页那种顶栏 + 列表）。
///
/// 落实方式：
...
///
/// ⚠️ **已知缺陷（2026-09-19 真机三验）**：卡片里的**底栏、玻璃球这类浮动层**不跟着
/// 卡片缩放（它们在首页里按屏幕尺寸摆位），玻璃的采样也会错位 —— 详见
/// `.agents/notes/implemented/feature/2026-09-19-appearance-editor.md` 的「Risks」。
/// 这里不要为了掩盖它再加补丁，先在真机确认整体方向。
///
