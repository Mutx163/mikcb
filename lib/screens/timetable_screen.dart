      ...
      builder: (context, provider, child) {
        ...
        final Widget dockContent = useHomePreblur
            ? PreblurredWallpaperScope(
                ...
                // 玻璃坞滑动转场（周↔日、课表↔设置）期间卡片在移动而壁纸
                // 屏幕固定：fill 必须每帧重采样，否则纹理停在旧屏幕位置
                // （卡片半边模糊半边透明）。合并展开动画与两个滑动转场。
