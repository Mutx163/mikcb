...
abstract final class AppLogMessageLocalizer {
  static String localizeMessage(AppLocalizations l10n, String message) {
    ...
    return switch (message) {
      ...
      'log_app_log_recording_remains_enabled' => l10n.logAppLogRecordingRemainsEnabled,
      'log_startup_flow_started' => l10n.logStartupFlowStarted,
      'log_startup_flow_completed_no_onboarding' => l10n.logStartupFlowCompletedNoOnboarding,
      'log_startup_flow_completed_after_guide' => l10n.logStartupFlowCompletedAfterGuide,
      ...
      'log_timetable_load_settings_failed' => l10n.logTimetableLoadSettingsFailed,
      'log_timetable_load_courses_failed' => l10n.logTimetableLoadCoursesFailed,
      'log_timetable_load_current_week_failed' => l10n.logTimetableLoadCurrentWeekFailed,
      'log_home_widget_pin_support_failed' => l10n.logHomeWidgetPinSupportFailed,
      'log_home_widget_pin_request_failed' => l10n.logHomeWidgetPinRequestFailed,
      ...
      'log_miui_live_open_promoted_settings_failed' => l10n.logMiuiLiveOpenPromotedSettingsFailed,
      'log_miui_live_open_notification_settings_failed' => l10n.logMiuiLiveOpenNotificationSettingsFailed,
      'log_miui_live_open_autostart_settings_failed' => l10n.logMiuiLiveOpenAutostartSettingsFailed,
      'log_miui_live_open_battery_settings_failed' => l10n.logMiuiLiveOpenBatterySettingsFailed,
      'log_miui_live_open_accessibility_settings_failed' => l10n.logMiuiLiveOpenAccessibilitySettingsFailed,
      'log_miui_live_hide_from_recents_failed' => l10n.logMiuiLiveHideFromRecentsFailed,
      ...
      'log_lan_edit_courses_batch_deleted' => l10n.logLanEditCoursesBatchDeleted,
      ...
      'log_live_update_test_selection_ready' => l10n.logLiveUpdateTestSelectionReady,
  ...
  static String localizeField(AppLocalizations l10n, String key) {
    ...
    return switch (mapped) {
      ...
      'log_field_has_notification_permission' => l10n.logFieldHasNotificationPermission,
      'log_field_has_promoted_permission_declared' => l10n.logFieldHasPromotedPermissionDeclared,
      'log_field_can_post_promoted_notifications' => l10n.logFieldCanPostPromotedNotifications,
      'log_field_ignoring_battery_optimizations' => l10n.logFieldIgnoringBatteryOptimizations,
      'log_field_keep_alive_accessibility_enabled' => l10n.logFieldKeepAliveAccessibilityEnabled,
      'log_field_hide_from_recents_enabled' => l10n.logFieldHideFromRecentsEnabled,
      ...
      'log_field_live_enable_before_class' => l10n.logFieldLiveEnableBeforeClass,
      'log_field_live_enable_during_class' => l10n.logFieldLiveEnableDuringClass,
      'log_field_live_enable_before_end' => l10n.logFieldLiveEnableBeforeEnd,
      'log_field_live_promote_during_class' => l10n.logFieldLivePromoteDuringClass,
      'log_field_live_show_during_class_notification' => l10n.logFieldLiveShowDuringClassNotification,
      ...
      'log_field_live_during_class_time_display_mode' => l10n.logFieldLiveDuringClassTimeDisplayMode,
      'log_field_live_enable_miui_island_label_image' => l10n.logFieldLiveEnableMiuiIslandLabelImage,
      'log_field_live_miui_island_label_style' => l10n.logFieldLiveMiuiIslandLabelStyle,
      'log_field_live_miui_island_label_content' => l10n.logFieldLiveMiuiIslandLabelContent,
      'log_field_live_miui_island_label_font_color' => l10n.logFieldLiveMiuiIslandLabelFontColor,
      'log_field_live_miui_island_label_font_weight' => l10n.logFieldLiveMiuiIslandLabelFontWeight,
      'log_field_live_miui_island_label_render_quality' => l10n.logFieldLiveMiuiIslandLabelRenderQuality,
      'log_field_live_miui_island_label_font_size' => l10n.logFieldLiveMiuiIslandLabelFontSize,
      'log_field_live_miui_island_label_offset_x' => l10n.logFieldLiveMiuiIslandLabelOffsetX,
      'log_field_live_miui_island_label_offset_y' => l10n.logFieldLiveMiuiIslandLabelOffsetY,
      'log_field_live_miui_island_expanded_icon_mode' => l10n.logFieldLiveMiuiIslandExpandedIconMode,
      'log_field_live_show_before_class_minutes' => l10n.logFieldLiveShowBeforeClassMinutes,
      'log_field_live_class_reminder_start_minutes' => l10n.logFieldLiveClassReminderStartMinutes,
      'log_field_live_end_seconds_countdown_threshold' => l10n.logFieldLiveEndSecondsCountdownThreshold,
  ...
  static String localizeCategory(AppLocalizations l10n, String category) {
    ...
    return switch (mapped) {
      ...
      'log_cat_app_lifecycle_state_changed' => l10n.logCatAppLifecycleStateChanged,
      ...
      'log_cat_timetable_load_settings_failed' => l10n.logCatTimetableLoadSettingsFailed,
      'log_cat_timetable_load_courses_failed' => l10n.logCatTimetableLoadCoursesFailed,
      'log_cat_timetable_load_current_week_failed' => l10n.logCatTimetableLoadCurrentWeekFailed,
      'log_cat_home_widget_pin_support_failed' => l10n.logCatHomeWidgetPinSupportFailed,
      'log_cat_home_widget_pin_request_failed' => l10n.logCatHomeWidgetPinRequestFailed,
      ...
      'log_cat_home_widget_schedule_failed' => l10n.logCatHomeWidgetScheduleFailed,
      'log_cat_miui_live_initialize_failed' => l10n.logCatMiuiLiveInitializeFailed,
      'log_cat_miui_live_open_promoted_settings_failed' => l10n.logCatMiuiLiveOpenPromotedSettingsFailed,
      'log_cat_miui_live_open_notification_settings_failed' => l10n.logCatMiuiLiveOpenNotificationSettingsFailed,
      'log_cat_miui_live_open_autostart_settings_failed' => l10n.logCatMiuiLiveOpenAutostartSettingsFailed,
      'log_cat_miui_live_open_battery_settings_failed' => l10n.logCatMiuiLiveOpenBatterySettingsFailed,
      'log_cat_miui_live_open_accessibility_settings_failed' => l10n.logCatMiuiLiveOpenAccessibilitySettingsFailed,
      'log_cat_miui_live_hide_from_recents_failed' => l10n.logCatMiuiLiveHideFromRecentsFailed,
      'log_cat_live_update_flutter_initialize_failed' => l10n.logCatLiveUpdateFlutterInitializeFailed,
      ...
      'log_cat_live_update_debug_status_failed' => l10n.logCatLiveUpdateDebugStatusFailed,
      'log_cat_live_update_settings_synced' => l10n.logCatLiveUpdateSettingsSynced,
      'log_cat_live_update_snapshot_sync_failed' => l10n.logCatLiveUpdateSnapshotSyncFailed,
      'log_cat_live_update_snapshot_clear_failed' => l10n.logCatLiveUpdateSnapshotClearFailed,
      ...
      'log_cat_lan_edit_course_group_saved' => l10n.logCatLanEditCourseGroupSaved,
      'log_cat_lan_edit_merge_imported' => l10n.logCatLanEditMergeImported,
      'log_cat_lan_edit_courses_batch_deleted' => l10n.logCatLanEditCoursesBatchDeleted,
      'log_cat_lan_edit_current_week_set' => l10n.logCatLanEditCurrentWeekSet,
      'log_cat_lan_edit_spreadsheet_imported' => l10n.logCatLanEditSpreadsheetImported,
      ...
      'log_cat_live_update_test_requested' => l10n.logCatLiveUpdateTestRequested,
      'log_cat_live_update_test_no_selection' => l10n.logCatLiveUpdateTestNoSelection,
      'log_cat_live_update_test_selection_ready' => l10n.logCatLiveUpdateTestSelectionReady,
      'log_cat_live_update_test_suspend_sync' => l10n.logCatLiveUpdateTestSuspendSync,
      ...
      'log_cat_live_update_snapshot_settings' => l10n.logCatLiveUpdateSnapshotSettings,
      'log_cat_live_update_snapshot_synced' => l10n.logCatLiveUpdateSnapshotSynced,
      'log_cat_live_update_snapshot_cleared' => l10n.logCatLiveUpdateSnapshotCleared,
      'log_cat_live_update_alarm_triggered' => l10n.logCatLiveUpdateAlarmTriggered,
      'log_cat_live_update_scheduler_resume' => l10n.logCatLiveUpdateSchedulerResume,
      'log_cat_live_update_reschedule_holiday' => l10n.logCatLiveUpdateRescheduleHoliday,
      'log_cat_live_update_reschedule_active' => l10n.logCatLiveUpdateRescheduleActive,
      'log_cat_live_update_reschedule_scheduled' => l10n.logCatLiveUpdateRescheduleScheduled,
      'log_cat_live_update_snapshot_parse_failed' => l10n.logCatLiveUpdateSnapshotParseFailed,
      'log_cat_live_update_snapshot_invalidated_after_upgrade' => l10n.logCatLiveUpdateSnapshotInvalidatedAfterUpgrade,
      'log_cat_live_update_payload_selected' => l10n.logCatLiveUpdatePayloadSelected,
      'log_cat_live_update_scheduler_start_failed' => l10n.logCatLiveUpdateSchedulerStartFailed,
      'log_cat_live_update_start_requested' => l10n.logCatLiveUpdateStartRequested,
      'log_cat_live_update_stop_requested' => l10n.logCatLiveUpdateStopRequested,
      'log_cat_live_update_service_missing_payload' => l10n.logCatLiveUpdateServiceMissingPayload,
      'log_cat_live_update_service_started' => l10n.logCatLiveUpdateServiceStarted,
      'log_cat_live_update_service_start_failed' => l10n.logCatLiveUpdateServiceStartFailed,
      'log_cat_live_update_task_removed' => l10n.logCatLiveUpdateTaskRemoved,
      'log_cat_live_update_task_removed_resumed' => l10n.logCatLiveUpdateTaskRemovedResumed,
      'log_cat_live_update_before_class_quick_action' => l10n.logCatLiveUpdateBeforeClassQuickAction,
      'log_cat_live_update_before_class_quick_action_restored' => l10n.logCatLiveUpdateBeforeClassQuickActionRestored,
      'log_cat_live_update_status_bar_dismissed' => l10n.logCatLiveUpdateStatusBarDismissed,
      'log_cat_live_update_not_promoted' => l10n.logCatLiveUpdateNotPromoted,
      'log_cat_live_update_promoted_not_shown' => l10n.logCatLiveUpdatePromotedNotShown,
      'log_cat_live_update_service_stopped' => l10n.logCatLiveUpdateServiceStopped,
      'log_cat_keep_alive_accessibility_connected' => l10n.logCatKeepAliveAccessibilityConnected,
