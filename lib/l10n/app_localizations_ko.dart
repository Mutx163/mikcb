...
class AppLocalizationsKo extends AppLocalizations {
  ...
  @override
  String get qrTransferSectionTitle => 'QR코드 직접 전송';

  @override
  String get qrTransferSectionSubtitle =>
      '두 기기를 가까이 대고 QR코드를 스캔하면 시간표와 설정을 네트워크 없이 전송합니다';

  @override
  String get qrTransferSendCurrent => '현재 시간표 전송';

  @override
  String get qrTransferSendAll => '모든 데이터 전송';

  @override
  String get qrTransferScanReceive => '스캔하여 받기';

  @override
  String qrTransferFrameProgress(int sent, int total) {
    return '$sent프레임 전송 / 약 $total프레임 필요';
  }

  @override
  String get qrTransferSendHint => '상대방이 「스캔하여 받기」를 열고 이 화면에 카메라를 대고 있게 하세요';

  @override
  String get qrTransferStop => '전송 중지';

  @override
  String get qrTransferScanTitle => '스캔하여 받기';

  @override
  String get qrTransferScanHint => '상대방 화면에 카메라를 대고 완료될 때까지 유지하세요';

  @override
  String qrTransferReceiveProgress(int received, int decoded, int total) {
    return '$received프레임 수신 · $decoded/$total 복호화됨';
  }

  @override
  String get qrTransferReceiveComplete => '데이터 수신 완료, 가져오는 중…';
  ...
  @override
  String get homeMenuAddCourseTitle => '추가';
  ...
  @override
  String get homeWidgetTargetStats22 => '통계 2×2';

  @override
  String get homeWidgetTargetStats24 => '통계 개요 2×4';

  @override
  String get homeWidgetTargetTodayStrip41 => '오늘 바 4×1';

  @override
  String get homeWidgetTargetStatsStrip41 => '통계 바 4×1';
  ...
  @override
  String get addCourseSheetTitle => '추가';
  ...
  @override
  String get examOverviewCountdown => '카운트다운';

  @override
  String get examOverviewCountdownUnit => '일 후';
  ...
  @override
  String get examOverviewInProgress => '시험 진행 중';

  @override
  String get examOverviewLiveBadge => '진행 중';
  ...
  @override
  String get examOverviewReminderOn => '알림 설정됨';

  @override
  String get examOverviewReminderOff => '알림 없음';
  ...
  String get settingsResetConfirmBodyTimetablePage =>
      '시간표 페이지의 밀도, 이번 주로 돌아가기 버튼, 배경(배경화면 삭제 포함)을 기본값으로 되돌립니다.';

  @override
  String get settingsResetConfirmBodyAppearance =>
      '테마 모드, 글꼴, 테마 색상과 유리 질감을 기본값으로 되돌립니다.';
  ...
  String get weekdayInkContrastBodyDark =>
      '요일 표시줄 텍스트 색상이 어두운 배경화면과 대비가 부족하여 읽기 쉽도록 자동으로 밝게 조정했습니다(색조는 그대로 유지). \"시간표 페이지 → 텍스트 색상\"에서 색상을 변경하거나 기본값으로 재설정할 수 있습니다.';

  @override
  String get weekdayInkContrastBodyLight =>
      '요일 표시줄 텍스트 색상이 밝은 배경화면과 대비가 부족하여 읽기 쉽도록 자동으로 어둡게 조정했습니다(색조는 그대로 유지). \"시간표 페이지 → 텍스트 색상\"에서 색상을 변경하거나 기본값으로 재설정할 수 있습니다.';
  ...
  @override
  String get homeDockEditorViewCategory => '뷰 전환';
  ...
  @override
  String get glassDockExtraButtonSemanticLabel => '추가';
  ...
  String get liveIslandExpandedPreviewCaption =>
      'Android 16에서 수업 중 진행 표시줄이 표시되면 확장 상태는 시스템이 그리므로 이 설정이 적용되지 않습니다';

  @override
  String get liveIslandExpandedPreviewEmptyHint =>
      '세부 행을 모두 숨겼습니다. 확장해도 제목과 요약만 표시됩니다';
  ...
  @override
  String get weatherShowOnWeekCardSubtitle => '칸이 좁아 한 항목만(기온 우선)';
