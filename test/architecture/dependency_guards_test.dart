...
void main() {
  ...
  test('timetable_provider.dart 行数棘轮：只减不增', () {
    ...
    // 按测试约定同步真实值。
    // 4433→4440: 合并漂移同步——体检④后台 persist/考试提醒单飞等改动在
    // main 上的合并格式化与逻辑收敛净 +7（85249d32→36761262），随后
    // 82f55c9d（Issue #52 审核 S4）新增 loadCustomHolidaysOrNull 薄转发
    // +7，主文件实测 4440；本 PR 未改 timetable_provider.dart，按测试
    // 约定同步真实值。
