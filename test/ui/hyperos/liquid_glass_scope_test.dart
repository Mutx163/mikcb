...
void main() {
  ...
  group('液态玻璃作用范围：模型层', () {
    ...
    test('「外观」恢复默认覆盖底栏开关（材质轴 2026-09-22 起归该作用域）', () {
      ...
      // 反过来：「课表页面」不再碰材质轴 —— 材质已是设备级设置（所有课表共用一份），
      // 在单张课表的恢复默认里重置它，会改掉别的课表也在用的那套。
      expect(
        applySettingsReset(dirty, SettingsResetScope.timetablePage)
