...
<header class="global-nav">
  <div class="nav-inner">
    <a class="nav-brand" href="{home}" aria-label="轻屿课表首页">
      <span class="nav-brand-mark"><img src="{prefix}app-icon.png" alt="轻屿课表图标" width="28" height="28" /></span>
      <span class="nav-brand-text">轻屿课表</span>
    </a>
    <nav class="nav-links" aria-label="站点导航">
      <a href="{home}#features">功能 / Features</a>
      <a href="{prefix}schools.html">学校 / Schools</a>
      <a href="{prefix}releases/">更新 / Releases</a>
      <a href="{prefix}course-import.html">导入 / Import</a>
    </nav>
    <div class="nav-actions">
      <a class="nav-github" href="https://github.com/Mutx163/mikcb" target="_blank" rel="noreferrer" aria-label="GitHub 仓库">GitHub</a>
      <a class="nav-download-button secondary-cta" href="{home}#download">下载 / Download</a>
    </div>
  </div>
</header>"""
