...
object DiagnosticLogMessages {
    ...
    const val LOG_KEEP_ALIVE_CONNECTED = "无障碍保活服务已连接"
    const val LOG_KEEP_ALIVE_REFRESH_WIDGET_FAILED = "连接时刷新小组件失败"
    const val LOG_KEEP_ALIVE_INTERRUPTED = "无障碍保活服务已中断"
    ...
    const val LOG_EXTERNAL_IMPORT_QUEUED = "外部导入已排队"
    ...
    const val LOG_INIT_UMENG_ANALYTICS = "正在初始化友盟统计"
