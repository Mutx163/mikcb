 ...
 * clock-app entries afterwards. All further management happens in the clock
 * app itself (ACTION_SHOW_ALARMS deep link plus stable labels).
 */
object SystemAlarmHelper {
    ...
    /**
     * Fires ACTION_SET_ALARM.
     *
     * [days] uses Calendar weekday constants (SUNDAY=1 ... SATURDAY=7);
     * an empty/null list means a one-shot alarm. Returns whether any clock
     * app actually handled the intent. Requesting skip-UI needs the
     * com.android.alarm.permission.SET_ALARM permission; whether the target
     * clock truly skips its confirmation page stays ROM-dependent by design.
     */
    fun fireSetAlarm(
        activity: Activity,
        hour: Int,
    ...
    /** Fires ACTION_SHOW_ALARMS; false when no clock app responds. */
